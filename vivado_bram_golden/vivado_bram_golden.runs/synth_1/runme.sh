...
HD_PWD='F:/AHE_Paper/vivado_bram_golden/vivado_bram_golden.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xilinx_true_dual_port_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xilinx_true_dual_port_ram.tcl
